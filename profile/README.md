...
Thank you [Zulip](https://zulip.com/) and [Coveralls](https://coveralls.io/) for sponsoring [winkJS](https://winkjs.org/).

**Love our work?** ⭐️ Star [winkNLP](https://github.com/winkjs/wink-nlp) and [winkComposer](https://github.com/winkjs/composer) — your support means the world to us! 🙏
